CREATE DATABASE  IF NOT EXISTS `meals` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `meals`;
...
INSERT INTO `recipe_ingredients` VALUES (1,1,'Boneless Skinless Chicken Breast',12.00,'oz'),(2,1,'Zucchini',2.00,'units'),(3,1,'Lemon',1.00,'units'),(4,1,'Persian Cucumber',1.00,'units'),(5,1,'Panko Breadcrumbs',0.50,'cup'),(6,1,'Sour Cream',1.00,'oz'),(7,1,'Crumbled Feta Cheese',0.50,'oz'),(8,1,'Garlic Cloves',2.00,'units'),(9,1,'Buttermilk-Dill Seasoning',1.00,'tsp'),(10,1,'Dill Sprigs',2.00,'units'),(11,2,'Ground Pork',10.00,'oz'),(12,2,'Green Bell Pepper',1.00,'units'),(13,2,'Long Grain White Rice',5.47,'oz'),(14,2,'Broccoli Florets',4.00,'oz'),(15,2,'Orange Ginger Ssame Sauce',4.00,'oz'),(16,2,'Wonton Strips',0.50,'oz'),(17,2,'Green Onions',2.00,'units'),(18,2,'Asian Garlic, Ginger & Chile Seasoning',1.00,'tsp'),(19,2,'Garlic Salt',0.50,'tsp'),(20,2,'Multicolor Sesame Seeds',1.00,'tsp'),(21,3,'Sliced Pork',10.00,'oz'),(22,3,'Red Onion',1.00,'units'),(23,3,'Small Flour Tortillas',6.00,'units'),(24,3,'BBQ Sauce',3.00,'oz'),(25,3,'Corn Kernels',3.00,'oz'),(26,3,'Shredded Cheddar Cheese',2.00,'oz'),(27,3,'Buttermilk Ranch Dressing',1.50,'fl. oz'),(28,3,'Crispy jalapenos',0.50,'oz'),(29,3,'Fiesta Seasoning',0.50,'tsp'),(30,4,'Yukon Potatoes',12.00,'oz'),(31,4,'Steak Strips',10.00,'oz'),(32,4,'Pretzel Buns',2.00,'units'),(33,4,'Cream Cheese',1.00,'oz'),(34,4,'Shredded Cheddar Cheese',1.00,'oz'),(35,4,'Green Onions',2.00,'units'),(36,4,'Mirepoix Broth Concentrate',2.00,'tsp'),(37,4,'Mushroom Seasoning',2.00,'tsp'),(38,4,'Garlic Pepper',0.50,'tsp'),(39,5,'Boneless Skinless Chicken Breasts',12.00,'oz'),(40,5,'Carrot',12.00,'oz'),(41,5,'Yukon Potatoes',12.00,'oz'),(42,5,'Cream Cheese',1.00,'oz'),(43,5,'Butter',1.00,'oz'),(44,5,'Roasted Garlic & Herb Butter',0.75,'oz'),(45,5,'Honey',1.00,'fl. oz'),(46,5,'Pine Nuts',1.00,'oz'),(47,5,'Rosemary Sprig',1.00,'units'),(48,5,'Seasoned Salt Blend',0.50,'tsp'),(49,6,'Patagonian petite Scallops',8.00,'oz'),(50,6,'Spaghetti',5.00,'oz'),(51,6,'Marinara Sauce',4.00,'oz'),(52,6,'Grape Tomatoes',4.00,'oz'),(53,6,'Shredded Asiago Cheese',1.00,'oz'),(54,6,'Arrabbiata Pesto',2.00,'Tbsp.'),(55,6,'Panko Breadcrumbs',0.25,'cup'),(56,6,'Garlic Cloves',2.00,'units'),(57,6,'Red Pepper Flakes',0.25,'tsp'),(58,6,'Garlic Salt',0.50,'tsp'),(59,7,'Salmon Fillets',12.00,'oz'),(60,7,'Zucchini',2.00,'units'),(61,7,'Lemon',1.00,'units'),(62,7,'Grape Tomatoes',4.00,'oz'),(63,7,'Grated Parmesan Cheese',1.00,'oz'),(64,7,'Butter',0.60,'oz'),(65,7,'Garlic Cloves',2.00,'units'),(66,7,'Capers',0.25,'units'),(67,8,'Shrimp',8.00,'oz'),(68,8,'Small Flour Tortillas',6.00,'units'),(69,8,'Slaw Mix',4.00,'oz'),(70,8,'Poblano Pepper',1.00,'unit'),(71,8,'Lime',1.00,'unit'),(72,8,'Mayonnaise',1.26,'oz'),(73,8,'Apricot Preserves',1.00,'oz'),(74,8,'Cornstarch',2.00,'Tbsp.'),(75,8,'Grated Cotija Cheese',0.50,'oz'),(76,8,'Ancho Cinnomon Rub',2.00,'tsp'),(77,9,'Ground Beef',10.00,'oz'),(78,9,'Carrot',8.00,'oz'),(79,9,'Zucchini',1.00,'units'),(80,9,'Cream Cheese',2.00,'oz'),(81,9,'Panko Breadcrumbs',0.25,'cup'),(82,9,'Green Onions',2.00,'units'),(83,9,'Grated Cotija Cheese',0.50,'oz'),(84,9,'Chipotle Pesto',1.00,'Tbsp.'),(85,9,'Chile and Cumin Rub',1.00,'tsp'),(86,9,'Onion Salt',1.00,'tsp'),(87,10,'Zucchini',2.00,'units'),(88,10,'Steelhead Trout Filets',10.00,'oz'),(89,10,'Red Bell Pepper',1.00,'units'),(90,10,'Tomato Feta Sauce',2.00,'oz'),(91,10,'Crumbled Feta Cheese',1.00,'oz'),(92,10,'Buttermilk-Dill Seasoning',1.00,'tsp'),(93,10,'Za\'atar Seasoning',1.00,'tsp'),(94,11,'Green Beans',12.00,'oz'),(95,11,'Ground Turkey',10.00,'oz'),(96,11,'Sun Dried Tomato pesto',1.00,'oz'),(97,11,'Beurre Blanc Butter',1.00,'oz'),(98,11,'Mayonnaise',0.84,'oz'),(99,11,'Roasted Sliced Almonds',0.50,'oz'),(100,11,'Grated Parmesan Cheese',0.50,'oz'),(101,11,'Saltine Crackers',2.00,'units'),(102,11,'Garlic Salt',0.50,'tsp'),(103,12,'Boneless Pork Chops',12.00,'oz'),(104,12,'Carrot',8.00,'oz'),(105,12,'Sweet Potato Cubes',8.00,'oz'),(106,12,'Walnut Halves',1.00,'oz'),(107,12,'Garlic Cloves',4.00,'units'),(108,12,'Cilantro',0.25,'oz'),(109,12,'Parsley',0.25,'oz'),(110,12,'Chimichurri Seasoning',2.00,'tsp'),(111,12,'Seasoned Salt Blend',1.00,'tsp'),(112,12,'Smoked Paprika',0.50,'tsp'),(113,13,'Red Beet',12.00,'oz'),(114,13,'Arborio Rice',0.75,'cup'),(115,13,'White Cooking Wine',2.00,'fl. oz'),(116,13,'Butter',1.00,'oz'),(117,13,'Goat Cheese',1.00,'oz'),(118,13,'Roasted Pistachios',0.75,'oz'),(119,13,'Grated Parmesan Cheese',0.50,'oz'),(120,13,'Mirepoix Broth Concentrate',2.00,'tsp'),(121,13,'Garlic Cloves',2.00,'units'),(122,14,'Russet Potato',1.00,'units'),(123,14,'Cubed Butternut Squash',8.00,'oz'),(124,14,'Cream Sauce Base',4.00,'fl. oz'),(125,14,'Ciabatta',1.00,'units'),(126,14,'Baby Spinach',2.00,'oz'),(127,14,'Shallot',1.00,'unit'),(128,14,'Shredded Cheddar-Jack Cheese',1.00,'oz'),(129,14,'Mirepoix Brother Concentrate',4.00,'tsp'),(130,14,'Butter',0.30,'oz'),(131,14,'Seasoned Salt Blend',1.00,'tsp'),(132,15,'Extra Firm Tofu',12.00,'oz'),(133,15,'Small Flour Tortillas',6.00,'units'),(134,15,'Pineapple Chunks',3.00,'oz'),(135,15,'Teriyaki Glaze',2.00,'fl. oz'),(136,15,'Jalapeno Pepper',1.00,'units'),(137,15,'Green Onions',2.00,'units'),(138,15,'Cornstarch',2.00,'Tbsp.'),(139,15,'Cilantro',0.25,'oz'),(140,15,'Asian Garlic, Ginger & Chile Seasoning',1.00,'tsp'),(141,16,'Par Cooked Asian Noodles',20.00,'oz'),(142,16,'Ground Turkey',16.00,'oz'),(143,16,'Green Bell Pepper',1.00,'units'),(144,16,'Matchstick Carrots',6.00,'oz'),(145,16,'Orange Ginger Seasme Sauce',6.00,'oz'),(146,16,'Peanut Butter',1.50,'oz'),(147,16,'Fried Rice Noodles',1.00,'oz'),(148,16,'Green Onions',2.00,'units'),(149,16,'Minced Garlic and parley',2.00,'tsp'),(150,16,'Asian, Ginger & Chile Seasoning',2.00,'tsp'),(151,17,'Sirloin Steaks',12.00,'oz'),(152,17,'Yukon Potatoes',12.00,'oz'),(153,17,'Balsamic Glaze',1.50,'fl. oz'),(154,17,'Grated Parmesan Cheese',1.00,'oz'),(155,17,'Tuscan Herb Butter',0.80,'oz'),(156,17,'Crispy Onions',0.50,'oz'),(157,17,'Minced Garlic and Parsley',1.00,'Tbsp.'),(158,17,'Mushroom Seasoning',1.00,'tsp'),(159,17,'Thyme Sprigs',3.00,'units'),(160,18,'Yellowtail Portions',10.00,'oz'),(161,18,'Mashed Potatoes',10.00,'oz'),(162,18,'Green Beans',8.00,'oz'),(163,18,'Cream Cheese',1.00,'oz'),(164,18,'Beurre Blanc Butter',1.00,'oz'),(165,18,'Green Onions',2.00,'units'),(166,18,'Crumbled Bacon',0.50,'oz'),(167,18,'Garlic Pepper',2.00,'tsp'),(168,18,'Buttermilk-Dill Seasoning',1.00,'tsp'),(169,19,'Pork Tenderloin Medallions',12.00,'oz'),(170,19,'Green Beans',8.00,'oz'),(171,19,'Cremini Mushrooms',4.00,'oz'),(172,19,'Caramelized Onion jam',1.00,'oz'),(173,19,'Roasted Garlic & Herb Butter',0.75,'oz'),(174,19,'Chicken Demi-Glace Concentrate',2.00,'tsp'),(175,19,'Chive Sprigs',6.00,'units'),(176,19,'Flour',0.25,'oz'),(177,19,'Garlic Salt',0.50,'tsp'),(178,19,'Coarse Black Pepper',0.50,'tsp'),(179,20,'Green Beans',12.00,'oz'),(180,20,'Boneless Skinless Chicken Breasts',12.00,'oz'),(181,20,'Lemon',1.00,'units'),(182,20,'Pure Maple Syrup',1.00,'fl. oz'),(183,20,'Roasted Sliced Almonds',0.50,'oz'),(184,20,'Chive Sprigs',6.00,'units'),(185,20,'Rotisserie Chicken Seasoning',0.50,'tsp'),(186,21,'Steak Strips',10.00,'oz'),(187,21,'Roma Tomato',1.00,'units'),(188,21,'Arborio Rice',3.60,'oz'),(189,21,'Corn kernels',3.00,'oz'),(190,21,'Grated Parmesan Cheese',2.00,'oz'),(191,21,'Sour Cream',2.00,'oz'),(192,21,'Green Onions',2.00,'units'),(193,21,'Natural Beef Flavor Demi-Glace Concentrate',2.00,'tsp'),(194,21,'Pot Roast Seasoning',1.50,'tsp'),(195,22,'Russet Potatoes',4.00,'units'),(196,22,'Boneless Skinless Chicken Breast Cutlet',20.00,'oz'),(197,22,'Brioche Buns',4.00,'units'),(198,22,'Slaw Mix',4.00,'oz'),(199,22,'Dill Pickle Slices',3.25,'oz'),(200,22,'BBQ Sauce',3.00,'oz'),(201,22,'Shredded Cheddar Cheese',2.00,'oz'),(202,22,'Buttermilk Ranch Dressing',1.50,'fl. oz'),(203,22,'Barbeque Seasoning',2.00,'tsp'),(204,22,'Garlic Salt',0.50,'tsp'),(205,23,'Cooked Gemelli Pasta',8.00,'oz'),(206,23,'Zucchini',1.00,'units'),(207,23,'Marinara Sauce',4.00,'oz'),(208,23,'Mixed Diced Peppers',4.00,'oz'),(209,23,'Prosciutto',2.00,'oz'),(210,23,'Shredded Asiago Cheese',1.00,'oz'),(211,23,'Sicilian Sauce',1.00,'oz'),(212,23,'Panko Breadcrumbs',0.25,'cup'),(213,23,'Garlic Salt',0.50,'tsp'),(214,23,'Red Pepper Flakes',0.25,'tsp'),(215,24,'Boneless Skinless Chicken Breasts',12.00,'oz'),(216,24,'Zucchini',2.00,'units'),(217,24,'Marinara Sauce',4.00,'oz'),(218,24,'Shredded Mozzarella',2.00,'oz'),(219,24,'Panko Breadcrumbs',0.50,'cup'),(220,24,'Shredded Parmesan Cheese',1.00,'oz'),(221,24,'Garlic Salt',0.50,'tsp'),(222,24,'Red Pepper Flakes',0.25,'tsp'),(223,25,'Steak Strips',8.00,'oz'),(224,25,'Arborio Rice',0.75,'cup'),(225,25,'Grape Tomatoes',4.00,'oz'),(226,25,'Shredded Asiago Cheese',2.00,'oz'),(227,25,'Basil Pesto',1.00,'oz'),(228,25,'Butter',0.60,'oz'),(229,25,'Green Onions',2.00,'units'),(230,25,'Mirepoix Broth Concentrate',2.00,'tsp'),(231,25,'Garlic Cloves',2.00,'units'),(232,25,'Garlic Salt',0.50,'tsp');
...
INSERT INTO `weekly_meals` VALUES (4,'3','test pizza'),(37,'4','test pizza 2');
...
-- Dump completed on 2024-10-22 20:46:06
